...
export class PostsService {
  ...
  constructor() { 
    ...
    this._publicaciones = [
      {
        id: 1,
        descripcion: "La vida es una aventura que tenemos el privilegio de disfrutar.",
        autor: "prettycorner",
        likes: 100,
      ...
      {
        id: 2,
        descripcion: "La dicha de la vida consiste en tener siempre algo que hacer, alguien a quien amar y alguna cosa que esperar.",
      ...
      {
        id: 3,
        descripcion: "La vida es como una caja de bombones nunca sabes lo que te va a tocar.",
        autor: "enigmaniac",
        likes: 56,
      ...
      {
        id: 4,
        descripcion: "A veces es necesario cambiar de ruta para llegar a nuestro destino.",
        autor: "incubuzz",
        likes: 23,
      ...
      {
        id: 5,
        descripcion: "Cometer errores en la vida no solo es honorable, es más útil que no hacer nada.",
        autor: "scentaurus",
        likes: 181,
      ...
      {
        id: 8,
        descripcion: "Somos lo que pensamos. Nos convertimos en nuestros pensamientos.",
        autor: "incubuzz",
        likes: 655,
      ...
      {
        id: 9,
        descripcion: "Hacen falta días malos para darte cuenta de lo bonitos que son el resto.",
        autor: "scentaurus",
        likes: 56,
      ...
      {
        id: 10,
        descripcion: "Éste es el secreto de la felicidad y la virtud: amar lo que uno tiene que hacer.",
        autor: "ohmmelette",
        likes: 65,
      ...
      {
        id: 11,
        descripcion: "El sentido de la vida es tener valores, no cosas de valor.",
        autor: "alteroid",
        likes: 890,
